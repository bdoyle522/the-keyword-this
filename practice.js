//We're in a job interview. Answer the following questions (try to not look at your notes unless you have to).
  // 1) What is the purpose of the 'this keyword'?
      ...
      //The purpose of the this keyword is to point to an object without making it specific to one object
  ...
  // 3) What is the difference between call and apply?
      ...
      //Call takes in specific arguments while apply can take in object arguments?

  // 4) What does .bind do?

      //.bind returns a function for use
...
Car.prototype.moveCar = function(){
    if(this.move === 10){return this.move+10;}
    return this.move = 10;
}
...
//that will allow for you to call the getYear function with the prius then the mustang objects being the focal objects. 
...
//Above you're given an object, a function, and a setTimeout invocation. After 5 seconds, what will the getUsername function return?
  ...
  //It will give a value of undefined
